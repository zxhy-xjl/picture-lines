 ...
 * 
 */
package com.zxhy.xjl.picture.lines.Impl;

import java.io.File;

import com.zxhy.xjl.picture.lines.service.QRPicService;
import com.zxhy.xjl.picture.lines.util.ImageHelper;
import com.zxhy.xjl.picture.lines.util.ImageUtil;
import com.zxhy.xjl.picture.lines.util.QRCodeUtil;
